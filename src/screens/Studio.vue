...
<template>
    <main class="bg-gray-50 dark:bg-slate-900 font-sans text-slate-900 dark:text-slate-200 h-screen flex flex-col rounded-3xl overflow-hidden">
        <div class="flex flex-1 overflow-hidden">
            ...
            <section class="w-[450px] shrink-0 border-l border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 flex flex-col overflow-y-auto">
                <div class="w-full">
                    <!-- Publishing Manager Accordion (moved above, closed by default) -->
                    <div>
                            ...
                            <div class="p-4">
                               <div class="mt-2 text-slate-700 dark:text-slate-300 bg-white/50 dark:bg-slate-900/50 rounded-lg space-y-4 p-4 border border-slate-200/50 dark:border-slate-700/50 backdrop-blur-sm">
                                    ...
                                    <p class="text-sm text-slate-600 dark:text-slate-400 mb-4">
                                        Publish your Mini App to EvoNext by creating and/or updating <span class="font-bold">Data Documents</span> on <span class="font-bold">Dash Drive</span>.
                                    </p>

                                    <div class="space-y-3 text-sm">
                                        <div class="bg-slate-100/50 dark:bg-slate-800 p-2 rounded border border-slate-200/50 dark:border-slate-700/50">
                    ...
                    <!-- Device Preview Accordion (moved below, open by default) -->
...
const htmlCode = ref(`<h1 class="text-2xl font-bold text-sky-600">
  Hello, EvoNext!
</h1>

<p>
  This is the first of many awesome mini apps.
</p>

<footer>
  ⋆.˚✮ brought to you with ❤️ by Satoshi ✮˚.⋆
</footer>`)
