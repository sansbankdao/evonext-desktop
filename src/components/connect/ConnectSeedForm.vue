...
onMounted(async () => {
  // Await the wordlist initialization
...
// Watcher fixed to handle the object structure from useDebounce properly
watch(
...
watch(localWordCount, (newCount) => {
  ...
  // Re-initialize states based on the new length, preserving where possible
