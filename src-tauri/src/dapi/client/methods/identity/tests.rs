...
async fn test_get_identity_balance_param_serialization() {
    ...
    let res = client
        .get_identity_balance(identity_id, Network::Mainnet)
        .await;
    assert!(res.is_err());
}
...
async fn test_get_identity_by_public_key_hash_params() {
    ...
    let res = client
        .get_identity_by_public_key_hash(public_key_hash, Network::Testnet)
        .await;
    assert!(res.is_err());
}
...
async fn test_get_identity_nonce_params() {
    ...
    let res = client
        .get_identity_nonce(identity_id, Network::Testnet)
        .await;
    assert!(res.is_err());
}
...
async fn test_get_identity_contract_nonce_params() {
    ...
    let res = client
        .get_identity_contract_nonce(identity_id, contract_id, Network::Testnet)
        .await;
    assert!(res.is_err());
}
...
async fn test_get_identity_token_balances_single_token() {
    ...
    let res = client
        .get_identity_token_balances(identity_id, token_ids, Network::Testnet)
        .await;
    assert!(res.is_err());
}
...
async fn test_get_identity_token_balances_multiple_tokens() {
    ...
    let res = client
        .get_identity_token_balances(identity_id, token_ids, Network::Mainnet)
        .await;
    assert!(res.is_err());
}
...
async fn test_get_identities_balances_single_identity() {
    ...
    let res = client
        .get_identities_balances(identity_ids, Network::Testnet)
        .await;
    assert!(res.is_err());
}
...
async fn test_get_identities_balances_multiple_identities() {
    ...
    let res = client
        .get_identities_balances(identity_ids, Network::Mainnet)
        .await;
    assert!(res.is_err());
}
...
async fn test_get_identity_balance_and_revision_params() {
    ...
    let res = client
        .get_identity_balance_and_revision(identity_id, Network::Testnet)
        .await;
    assert!(res.is_err());
}
...
async fn test_get_identities_contract_keys_with_purposes() {
    ...
    let res = client
        .get_identities_contract_keys(identity_ids, contract_id, purposes, Network::Mainnet)
        .await;
    assert!(res.is_err());
}
...
async fn test_get_identities_contract_keys_empty_identities() {
    ...
    let res = client
        .get_identities_contract_keys(identity_ids, contract_id, Some(vec![0]), Network::Testnet)
        .await;
    assert!(res.is_err());
}
...
async fn test_get_identities_contract_keys_empty_purposes() {
    ...
    let res = client
        .get_identities_contract_keys(identity_ids, contract_id, purposes, Network::Testnet)
        .await;
    assert!(res.is_err());
}
...
async fn test_network_variants_get_identity() {
    ...
    let res = client
        .get_identity("test_id".to_string(), Network::Testnet)
        .await;
    assert!(res.is_err());

    // Test with explicit Mainnet
    let res = client
        .get_identity("mainnet_id".to_string(), Network::Mainnet)
        .await;
    assert!(res.is_err());
}
...
async fn test_network_variants_get_balance() {
    ...
    let res = client
        .get_identity_balance("testnet_balance".to_string(), Network::Testnet)
        .await;
    assert!(res.is_err());

    let res = client
        .get_identity_balance("mainnet_balance".to_string(), Network::Mainnet)
        .await;
    assert!(res.is_err());
}
