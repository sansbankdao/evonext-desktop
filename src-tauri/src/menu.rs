...
use tauri::{
    menu::{CheckMenuItemBuilder, MenuBuilder, MenuItem, SubmenuBuilder, MenuId},
...
/// Testable logic that accepts a MenuId instead of the opaque MenuEvent
fn handle_id<R: Runtime>(app: &AppHandle<R>, id: &MenuId) {
